 ...
 *
 * It lives beside the database client because the connection string is what
 * made the duplication dangerous in the first place, and because every process
 * that needs the file is already reaching for this folder.
 */
