 ...
 */
// `__dirname`, not `import.meta.url`: this app compiles to CommonJS because
// NestJS needs legacy decorators and `emitDecoratorMetadata` (docs/05), and
// `import.meta` is a syntax error in a CommonJS build. The schema now sits two
// levels up, at apps/api/prisma.
