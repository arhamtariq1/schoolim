...
| Fees › Defaulter List | Fees › Defaulters | Becomes a *worklist* with reminder actions, not a report |
...
| Fees › Student list | *(removed)* | It was a duplicate of Students with a fee filter — now a saved view |
