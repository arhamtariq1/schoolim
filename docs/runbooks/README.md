...
Each is written for _someone who is not you_: no undocumented steps, no "obviously then you…". The
test is whether a competent developer with repo access could execute it cold (`18` §8).
