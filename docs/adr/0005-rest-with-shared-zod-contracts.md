...
- Cost: slightly more ceremony than tRPC — an explicit route, schema and client call. In exchange the
  boundary is visible and documented, which matters more in a system where every boundary crossing is
  a permission and tenancy checkpoint.
