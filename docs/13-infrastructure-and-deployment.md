...
Also: 500 MB storage, 500 MB shared RAM, 60 direct connections / 200 pooler connections, 5 GB
egress.
...
- **The auto-pause is disqualifying for a live school.** A paused project means the portal is down
  and nobody can collect a fee. A keep-alive ping avoids it, but running a paying customer on a tier
  that pauses on a technicality is not a decision you want to defend at 9 a.m. on a Monday.
...
**Sources:** [Vercel Hobby plan terms](https://vercel.com/docs/plans/hobby) ·
...
[Supabase free-tier limits](https://uibakery.io/blog/supabase-pricing)
